...
const students: Student[] = [
  { id: '1', name: 'Ravi Kumar', avatar: 'https://picsum.photos/seed/1/100/100', email: 'ravi.kumar@example.com', class: '10A', attendance: 92, overallScore: 88 },
  { id: '2', name: 'Priya Sharma', avatar: 'https://picsum.photos/seed/2/100/100', email: 'priya.sharma@example.com', class: '10A', attendance: 95, overallScore: 94 },
  { id: '3', name: 'Amit Singh', avatar: 'https://picsum.photos/seed/3/100/100', email: 'amit.singh@example.com', class: '10A', attendance: 88, overallScore: 76 },
  { id: '4', name: 'Sneha Patel', avatar: 'https://picsum.photos/seed/4/100/100', email: 'sneha.patel@example.com', class: '10A', attendance: 98, overallScore: 91 },
  { id: '5', name: 'Mohit Verma', avatar: 'https://picsum.photos/seed/5/100/100', email: 'mohit.verma@example.com', class: '10A', attendance: 75, overallScore: 65 },
];

const teachers: Teacher[] = [
    { id: 't-1', name: 'Mr. Sharma', email: 'sharma@example.com', avatar: 'https://picsum.photos/seed/teacher/100/100', role: 'Class Teacher' },
    { id: 't-2', name: 'Ms. Gupta', email: 'gupta@example.com', avatar: 'https://picsum.photos/seed/faculty1/100/100', role: 'Subject Teacher' },
    { id: 't-3', name: 'Mr. Khan', email: 'khan@example.com', avatar: 'https://picsum.photos/seed/faculty2/100/100', role: 'Subject Teacher' },
    { id: 'p-1', name: 'Principal Singh', email: 'principal@example.com', avatar: 'https://picsum.photos/seed/principal/100/100', role: 'Principal' },
];
...
const lessonVideos: LessonVideo[] = [
    { id: '1', title: 'Introduction to Photosynthesis', subject: 'Science', teacher: 'Mr. Khan', thumbnailUrl: 'https://picsum.photos/seed/v1/400/225', videoUrl: '#', watched: true },
    { id: '2', title: 'The Laws of Motion', subject: 'Science', teacher: 'Mr. Khan', thumbnailUrl: 'https://picsum.photos/seed/v2/400/225', videoUrl: '#', watched: false },
    { id: '3', title: 'Solving Linear Equations', subject: 'Mathematics', teacher: 'Ms. Gupta', thumbnailUrl: 'https://picsum.photos/seed/v3/400/225', videoUrl: '#', watched: true },
    { id: '4', title: 'Introduction to Trigonometry', subject: 'Mathematics', teacher: 'Ms. Gupta', thumbnailUrl: 'https://picsum.photos/seed/v4/400/225', videoUrl: '#', watched: false },
    { id: '5', title: 'Shakespeare\'s Sonnets', subject: 'English', teacher: 'Mr. Sharma', thumbnailUrl: 'https://picsum.photos/seed/v5/400/225', videoUrl: '#', watched: false },
];
